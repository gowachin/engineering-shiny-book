...
But from time to time, a new version means breaking changes. **Monitoring these changes and how they potentially break our code is an hard task: be it because checking versions of packages on various machines can take time**, or because debugging these bugs in your application logs is not straightforward.
